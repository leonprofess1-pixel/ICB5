...
![성과 등급과 이탈률의 관계](./images_v2/11_performance_rating_attrition.png)

### 🔍 관찰 (Observation)
- 성과 등급 3(Excellent)과 4(Outstanding) 모두에서 이탈률이 약 33~34%로 나타나, 두 그룹 간에 유의미한 차이가 없습니다.
- 절대적인 이탈자 수는 성과 등급 3에서 훨씬 많지만, 이는 해당 등급에 직원이 집중되어 있기 때문입니다.

### 💡 인사이트 (Insight)
성과 등급이 이탈률에 거의 영향을 주지 못하고 있습니다. 이는 현재의 성과 평가 시스템이 직원들의 실제 기여도를 제대로 반영하지 못하거나, 혹은 '우수' 인재로 평가받는 직원들조차 조직에 만족하지 못하고 이탈하고 있음을 시사하는 심각한 신호입니다. 즉, 성과 관리가 인재 유지(Retention) 기능에 실패하고 있습니다.

### 🚀 액션 플랜 (Action Plan)
- **(최우선) 성과 평가 시스템 전면 재검토:** 현재 평가 지표가 실질적인 성과와 동기부여에 기여하는지 원점에서 재검토해야 합니다. 특히, 상위 평가 등급(4등급)에 대한 차별화된 보상 및 인정 프로그램을 즉시 강화해야 합니다.
